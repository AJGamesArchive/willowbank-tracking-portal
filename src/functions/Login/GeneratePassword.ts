 ...
 * @param {string} firstName The users entered first name
 * @param {string} surnameInitial The users entered surname initial
 * @returns {string} Returns a password in the format of: [Surname Initial][Animal Name][Forename Initial][@][Current Seconds]
 * @example Example - wELEPHANTA@39
 * @AJGamesArchive
 */
